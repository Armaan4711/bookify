import { assets } from "../assets/assets";
 ...
 export default function Footer  () {
    return (
        <footer className="px-6 pt-8 md:px-16 lg:px-36 w-full text-gray-800 my-17  ">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-t  border-gray-500 p-10">

...
const Adminlayout = () => {
 ...
 const {setisadmin,navigate,axios,authReady,isadmin }=useContext(Appcontext)
  // ⛔ Wait until auth check finishes (REMOVE FLICKER)
  if (!authReady) {
  ...
  if (!isadmin) {
    ...
    const sidebarLinks = [
        { name: "All books", path: "/admin", icon: dashboardicon },
        { name: "Add Book", path: "/admin/add-product", icon: overviewicon },

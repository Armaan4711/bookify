...
function BookDetails() {
  ...
  useEffect(() => {
  if (product) setthumbnail(`http://localhost:5000/images/${product.image}`);
}, [product]);
 return product && (
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        className="w-full py-3.5 cursor-pointer font-medium bg-gray-100 text-gray-800/80 hover:bg-gray-300 transition" >
                            Add to Cart
                        </button>
                        <button
                         onClick={()=>{addtocart(product)

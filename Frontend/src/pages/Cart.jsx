          ...
          <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
            <div className="flex items-center md:gap-6 gap-3">
              <div className="cursor-pointer w-24 h-24 flex items-center justify-center border border-gray-300 rounded overflow-hidden">
                <img
                  className="max-w-full h-full object-cover" src={`http://localhost:5000/images/${product.image}`} alt={product.title} />
              </div>
              <div>
            ...
            <button
              onClick={() => removefromcart(product._id)} className="cursor-pointer mx-auto">
        ...
        <div className="mb-6">
          ...
          <div className="relative flex justify-between items-start mt-2">
            <p className="text-gray-500">
              {selectedaddress ?
                `${selectedaddress.fullname},${selectedaddress.city}, ${selectedaddress.state},${selectedaddress.country}` : "no address found"}
            </p>
              ...
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                {address.map((address, index) => (
                  <p
                    ...
                    {address.fullname},{address.city},{address.state},{address.postalcode},{" "},{address.country}
                  </p>
                ))}
                <p onClick={() =>
